label start:
    ...
    you "I {b}don't{/b} mom.. I'll go get ready right away.."
        ...
        "Yes, Take a shower..":
            ...
            if not remember:
                ...
                if wanna_die==True:
                    ...
                    empty "{i} I have to find out who {i}she{/i} is..{/i}"
                    speaker "You try to get up but you are {i}too weak{/i} to do anything.."
                    speaker "You muster up all your strength into a {b}loud cry{/b}."
                    you "{size=+8}MOM!! PLEASE HELP ME!!{/size}"
                    speaker "Your mom hears you and runs towards the washroom."
                    mom "{size=+8}WHAT HAPPENED?? ARE YOU OKAY??{/size}"
                    speaker "Your mom sees you on the floor.."
                    mom "{size=+8}OH MY GOD AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH!!{/size}"
                    scene bg ambulance with fade
                    speaker "Your neighbours hear the {b}screams{/b} and quickly dial {i}911{/i}.."
                    speaker "An {i}ambulance{/i} arrives and you are rushed to the hospital.."
                    scene bg hospital with fade
                    doctor "He has a {b}concussion{/b} and a few broken bones.."
                    doctor "We have to perform an {b}immediate surgery{/b} to save his life.."
                    mom "{size=+6}Please!!{/size} Please.. do whatever you can to save him.. {i}please.. please..{/i}"

                    speaker "The doctor and his team start the {b}surgery{/b} without any delay.."
                    speaker "Your mom is {i}praying to god{/i} for you.."
                    speaker "You are put under {b}anesthesia{/b} and you slowly lose the little bit of {i}consciousness{/i} you still had.."

                    scene bg park with fade
                    empty "{i} {b}Where..{/b} Where am I...{/i}"
                    mystery 'Hello there..'
                    you "Huh?? Who's there??"
                    mystery "It's me duhh"
                    you "Wait.. how do you know me??"
                    empty "{b}{size=+6}Thump!!{/size}{/b}"
                    speaker "She pats your head angrily."
                    mystery "How do you {b}not{/b} remember me.. We've known each other for {b}so long..{/b}"
                    you "{i}Oww oww..{/i}"
                    you "Hitting me isn't going to help! I {i}still {b}dont{/b} remember{/i} who you are.."
                    mystery "You {b}{size=+3}idiot{/size}{/b}.. I thought you were smarter than this.."
                    mystery " My #a*@! $* .."
                    mystery "D- y*u r-me-b-r -* n0*?"
                    speaker "You see her trying to say something but you {i}don't understand{/i} what she is saying.."
                    speaker "Her voice starts to fade away and the words start to slur.."
                    # play thump sound
                    speaker "You feel a {i}sharp {b}pain{/b}{/i} in your ears and you collapse on the ground..."
                    empty "... ... ..."
                    empty "... ... ..."
                    scene bg hospital with fade
                    speaker "You gain back your {i}conciousness{/i}.."
                    speaker 'You see the doctor and your mom are talking to each other..'
                    doctor "The {b}operation{/b} was a {b}success{/b} he should wake up anytime soon."
                    mom "{size=+6}Ohh thank god..{/size} thank you so much doctor.. I'm ever so grateful.."
                    doctor 'He should be fine but he might have some {b}memory loss{/b}..'
                    doctor "His brain was {b}damaged{/b} {i}pretty badly{/i}.. so his words might be slurry or what he's saying might not make sense.."

                    speaker "Your mom notices you moving your eyes.."
                    mom "{b}{size=+6}[player]??{/size}{/b} Are you awake?? Can you hear me??"
                    you "{b}Mom??{/b} Where am I?? What happened??"
                    mom "{b}{size=+7}OHH MY GOD!!{/size}{/b} .. you are awake!!"
                    ...
                    you "But.. but I {b}have{b} to go to the Airport!"
                    you "I have to.."
                    ...
                    mom "I never said that dear.. You've {b}hurt{/b} your head.. you need to {i}rest and recover{/i}.."
                    speaker "The doctor {i}whispers{/i} to your mom."
                    ...
                    speaker "Your mom looks at you and {i}smiles softly{/i}."
